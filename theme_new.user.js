...
for (var i = 0; i < images.length; ++i) {
        ...
        images[i].src = images[i].src.replace('https://hackforums.net/images/modern_bl/logo_bl.gif', 'https://notcammy.github.io/HF-Old-School-Theme/theme_images/logo.jpg');
        images[i].src = images[i].src.replace('https://hackforums.net/images/modern_pl/logo_pl.gif', 'https://notcammy.github.io/HF-Old-School-Theme/theme_images/logo.jpg');
