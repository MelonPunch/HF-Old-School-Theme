...
function uberPMDeny() {
    try{
        ...
        denyURL = "https://hackforums.net/private.php?action=read&pmid="+pmid+"&denyreceipt=1";
...
function addSpecialLinks(){
    ...
    if(GM_config.get('showBuddyLink', true)){
        ...
        //$("#buddylist").live("click", function(){MyBB.popupWindow("https://hackforums.net/misc.php?action=buddypopup", "buddyList", 350, 350);});
...
function showBuddyList(){
    window.open('https://hackforums.net/misc.php?action=buddypopup', 'HF Buddy List', 'height=350,width=350,resizable=0,location=0,left=0,top=0');
}
    ...
    try{
        GM_xmlhttpRequest({
            ...
            onload: function(response){
                ...
                hideButton = '<div class="float_right"><a href="javascript:void(0);" title="Dismiss this notice" id="hider"><img src="https://hackforums.net/images/modern_bl/dismiss_notice.gif" alt="Dismiss this notice" title="[x]"></a></div>';
                ...
                GM_xmlhttpRequest({
                    ...
                    onload: function(response){
                        ...
                        if(response.responseText.indexOf("member_profile_online") != -1){
                            imageHTML = '<img src="https://hackforums.net/images/modern_bl/buddy_online.gif" alt="Online" title="Online">  ';
                        }else{
                            imageHTML = '<img src="https://hackforums.net/images/modern_bl/buddy_offline.gif" alt="Offline" title="Offline">  ';
                        }
...
function getThreadOP(htmlCode){ // HOLDER2
    ...
    authorString = "[url=https://hackforums.net/member.php?action=profile&uid="+uid+"]"+author+"[/url]";
...
function addQuickMsg(){
    ...
    GM_xmlhttpRequest({
        method: "GET",
        url: "https://hackforums.net/private.php?action=send&pmid="+pmid,
        onload: function(response){
...
function addLastLinks(){
    ...
    flag = false;
    for(i=0; i<docSplit.length; i++){
        if((docSplit[i].indexOf('<img src="https://hackforums.net/images') != -1 || docSplit[i].indexOf('https://hackforums.net:8080/images') != -1) && flag == false){
            prevLine = i;
            flag = true;
        }
...
function addPostPM(){
    ...
    for(i=1; i<postData.length; i++){
        if(postData[i].innerHTML.indexOf('id="post_') != -1 && postData[i].innerHTML.indexOf('href="private.php?action=send') != -1){
            ...
            message = '&subject=Re%3A%20Your%20Post&message=[align%3Dright][size%3Dx-small][i][This%20PM%20is%20in%20regards%20to%20[url=https://hackforums.net/showthread.php?tid%3D'+tid+'%26pid%3D'+pid+'%23pid'+pid+']a%20post%20you%20made[/url]][/i][/size][/align]';
...
var initializeFavorites = function() {
    ...
    GM_xmlhttpRequest({ 
        ...
        onload: function(response) {
            ...
            document.head.innerHTML += '<link type="text/css" rel="stylesheet" href="https://hackforums.net/cache/themes/theme5/global.css">'
...
function addQuoteToMulti(buttonId){
    ...
    if($('#'+buttonId)[0].innerHTML.indexOf('+') != -1){
        ...
        GM_xmlhttpRequest({
            method: "GET",
            url: 'https://hackforums.net/newreply.php?tid='+tid+'&replyto='+pid,
            onload: function(response){
                try{
...
function previewThreadsForum(result){
    ...
    if($('#preview_'+tid+'_fin').length <= 0){
        ...
        GM_xmlhttpRequest({
            method: "GET",
            url: 'https://hackforums.net/showthread.php?tid='+tid,
...
function postAddSmiley(){
    var i, posts;
    var allSmileys = {
        ":pinch:":"<img src='https://hackforums.net/images/smilies/pinch.gif'>",
        ":victoire:":"<img src='https://hackforums.net/images/smilies/victoire.gif'>",
        ":hehe:":"<img src='https://hackforums.net/images/smilies/hehe.gif'>",
        ":oui:":"<img src='https://hackforums.net/images/smilies/oui.gif'>",
        ":bebe-pleure:":"<img src='https://hackforums.net/images/smilies/bebe-pleure.gif'>",
        ":ohmy:":"<img src='https://hackforums.net/images/smilies/ohmy.gif'>",
        ":blink:":"<img src='https://hackforums.net/images/smilies/blink.gif'>",
        ":superman:":"<img src='https://hackforums.net/images/smilies/superman.gif'>",
        ":nono:":"<img src='https://hackforums.net/images/smilies/nono.gif'>",
        ":biggrin:":"<img src='https://hackforums.net/images/smilies/biggrin.gif'>",
        ":sad:":"<img src='https://hackforums.net/images/smilies/sad.gif'>",
        ":unsure:":"<img src='https://hackforums.net/images/smilies/unsure.gif'>",
        ":glare:":"<img src='https://hackforums.net/images/smilieslare.gif'>",
        ":roflmao:":"<img src='https://hackforums.net/images/smilies/roflmao.gif'>",
        ":devlish:":"<img src='https://hackforums.net/images/smilies/devlish.gif'>",
        ":rolleyes:":"<img src='https://hackforums.net/images/smilies/rolleyes.gif'>",
        ":cool:":"<img src='https://hackforums.net/images/smilies/cool.gif'>",
        ":gratte:":"<img src='https://hackforums.net/images/smiliesratte.gif'>",
        ":confused:":"<img src='https://hackforums.net/images/smilies/confused.gif'>",
        ":blackhat:":"<img src='https://hackforums.net/images/smilies/blackhat.gif'>",
        ":ninja:":"<img src='https://hackforums.net/images/smilies/ninja.gif'>",
        ":blush:":"<img src='https://hackforums.net/images/smilies/blush.gif'>",
        ":lipssealed:":"<img src='https://hackforums.net/images/smilies/lipssealed.gif'>",
        ":yeye:":"<img src='https://hackforums.net/images/smilies/yeye.gif'>",
        ":non:":"<img src='https://hackforums.net/images/smilies/non.gif'>",
        ":smile:":"<img src='https://hackforums.net/images/smilies/smile.gif'>",
        ":whistle:":"<img src='https://hackforums.net/images/smilies/whistle.gif'>",
        ":sleep:":"<img src='https://hackforums.net/images/smilies/sleep.gif'>",
        ":evilgrin:":"<img src='https://hackforums.net/images/smilies/evilgrin.gif'>",
        ":omg:":"<img src='https://hackforums.net/images/smilies/omg.gif'>",
        ":tongue:":"<img src='https://hackforums.net/images/smilies/tongue.gif'>",
        ":mad:":"<img src='https://hackforums.net/images/smilies/mad.gif'>",
        ":huh:":"<img src='https://hackforums.net/images/smilies/huh.gif'>",
        ":thumbsup:":"<img src='https://hackforums.net/images/smilies/thumbsup.gif'>",
        ":wacko:":"<img src='https://hackforums.net/images/smilies/wacko.gif'>",
        ":pirate:":"<img src='https://hackforums.net/images/smilies/pirate.gif'>",
...
function getBanReasonProfile(){
    if($('.group7').length > 0){
        ...
        GM_xmlhttpRequest({
            method: "GET",
            url: 'https://hackforums.net/bans.php',
